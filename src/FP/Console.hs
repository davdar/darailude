...
fgCode = (++) "38;5;" . show . ton

bgCode :: Color256 -> String
bgCode = (++) "48;5;" . show . ton
...
pprintWith f = printLn . formatOut . execDoc . f . pretty
...
htmlColorFrom256 = map (mapFst toi)
  [ (000, "#000000")
  , (001, "#800000")
  , (002, "#008000")
  , (003, "#808000")
...
htmlFGCode c s = "<span style='color:" ++ (htmlColorFrom256 #! color256Raw c) ++ "'>" ++ s ++ "</span>"

htmlBGCode :: Color256 -> String -> String
htmlBGCode c s = "<span style='background-color:" ++ (htmlColorFrom256 #! color256Raw c) ++ "'>" ++ s ++ "</span>"
